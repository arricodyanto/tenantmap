        ...
        <React.Fragment>
            ...
            <TransformComponent>
                ...
                {itemPopover.map((item) => (
                    <>
                        {/* Handle Popover */}
                        <Box id={item.id} sx={{ top: `${item.top}`, left: `${item.left}` }} className='absolute hover:brightness-110 hover:cursor-pointer' onMouseEnter={handlePopoverOpen} onMouseLeave={handlePopoverClose} onClick={handleClick}>
                            <FmdGoodIcon sx={{fontSize: 12, color: '#af003a'}}/>
                        </Box>
                    </>
                ))}

                {/* Popover on Click Element */}
                <Popover id={id} open={openEl} anchorEl={anchorClick} onClose={handleClose} anchorOrigin={{ vertical: 'top', horizontal: 'center', }} transformOrigin={{ vertical: 'bottom', horizontal: 'center', }}>
                    <CardContent id='popo' className='w-80'>
                        <Typography sx={{ textTransform: 'uppercase', fontStyle: 'bold', fontSize: '16',}}>
                ...
                {/* Popover on Hover Element */}
                <Popover id="mouse-over-popover" sx={{ pointerEvents: 'none', }} open={open} anchorEl={anchorEl} anchorOrigin={{ vertical: 'top', horizontal: 'center', }} transformOrigin={{ vertical: 'bottom', horizontal: 'center', }} onClose={handlePopoverClose} disableRestoreFocus>
                    <Card className='w-32 h-32 p-2'>
                        <CardActionArea>
                            <CardMedia component="img" height="140" image="https://source.unsplash.com/random/128x128" alt="green iguana"/>
                        </CardActionArea>
                    </Card>
                </Popover>
                ...
                <svg width="1080" height="900" viewBox="0 0 1080 900" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="GF">
                        ...
                        <g id="34" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('34', 4, 100)}>
                        ...
                        <g id="35" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('35', 4, 100)}>
                        ...
                        <g id="36" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('36', 4, 100)}>
                        ...
                        <g id="37" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('37', 4, 100)}>
                        ...
                        <g id="01" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('01', 4, 100)}>
                        <g id="01s">
                        ...
                        <g id="02" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('02', 4, 100)}>
                        ...
                        <g id="03" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('03', 4, 100)}>
                        ...
                        <g id="04" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('04', 4, 100)}>
                        ...
                        <g id="05" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('05', 4, 100)}>
                        ...
                        <g id="06" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('06', 4, 100)}>
                        ...
                        <g id="07" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('07', 4, 100)}>
                        ...
                        <g id="08" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('08', 4, 100)}>
                        ...
                        <g id="09" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('09', 4, 100)}>
                        ...
                        <g id='10' className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('10', 4, 100)}>
                        ...
                        <g id="38" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('38', 4, 100)}>
                        ...
                        <g id="39" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('39', 4, 100)}>
                        ...
                        <g id="40" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('40', 4, 100)}>
                        ...
                        <g id="16" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('16', 4, 100)}>
                        ...
                        <g id="17" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('17', 4, 100)}>
                        ...
                        <g id="18" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('18', 4, 100)}>
                        ...
                        <g id="19" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('19', 4, 100)}>
                        ...
                        <g id="20" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('20', 4, 100)}>
                        ...
                        <g id="21" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('21', 4, 100)}>
                        ...
                        <g id='22' className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('22', 4, 100)}>
                        ...
                        <g id="11" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('11', 4, 100)}>
                        ...
                        <g id="12" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('12', 4, 100)}>
                        ...
                        <g id="13" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('13', 4, 100)}>
                        ...
                        <g id="14" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('14', 4, 100)}>
                        ...
                        <g id="15" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('15', 4, 100)}>
                        ...
                        <g id="23" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('23', 4, 100)}>
                        ...
                        <g id="24" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('24', 4, 100)}>
                        ...
                        <g id="25" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('25', 4, 100)}>
                        ...
                        <g id="26" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('26', 4, 100)}>
                        ...
                        <g id="27" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('27', 4, 100)}>
                        ...
                        <g id="28" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('28', 4, 100)}>
                        ...
                        <g id="29" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('29', 4, 100)}>
                        ...
                        <g id="30" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('30', 4, 100)}>
                        ...
                        <g id="31" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('31', 4, 100)}>
                        ...
                        <g id="32" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('32', 4, 100)}>
                        ...
                        <g id="33" className="hover:brightness-110 hover:-translate-y-[1px] transition-all ease-in-out hover:cursor-pointer" aria-describedby={id} onClick={() => zoomToElement('33', 4, 100)}>
